        ...
        {for $i=0 to $size} 
            <div class="col mb-4">
                <div class="card myCard">
                    <img src="{$imagenes[$i]}" class="card-img-top p-1" alt="imagen de {$productos[$i]->nombre}">
                    <div class="card-body">
                        ...
                        <ul class="card-text prodList"> 
                            ...
                            <li> Categoria {$productos[$i]->name|capitalize} </li>
                        </ul>
                    </div>
                    <div class="card-footer">
                        <button class='btn' type='button'><a class='btn btn-secondary'
                            href="verDetalle/{$productos[$i]->id}">Detalle</a>
                        </button>
                        {if $sesion==="admin"}
                            <button class='btn' type='button'><a class='btn btn-warning'
                                href="formEditar/{$productos[$i]->id}">Editar
                            ...
                            <button class='btn' type='button'><a class='btn btn-outline-danger'
                                href="eliminarProducto/{$productos[$i]->id}">Eliminar 
            ...
            <td><button class='btn btn-secondary' type='button'><a class='btn btn-secondary btn-lg active'
                ...
                {if $sesion==="admin"} 
                    ...
                    <td><button class='btn btn-secondary' type='button'><a class='btn btn-outline-danger btn-lg active'
                        href="eliminarProducto/{$producto->id}">Eliminar 
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                        <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                        </svg>
