...
<div class="d-flex justify-content-center border-top border-bottom mb-4 bg-light">
    <div class="container d-inline-flex pb-0 justify-content-center">
        {if $pagina > 0} 
            <button class='btn' type='button'><a class='btn' href="home/{$pagina-1}">
